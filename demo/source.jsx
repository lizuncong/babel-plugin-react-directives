...
const LazyImg: React.FC<ILazyImg> = (props: ILazyImg) => {
  ...
  const { src = '', wrapperdivheight100 = false, wrapperdivstyle = {}, visibleByDefault, noWrapper, ...restProps } = props;
  let newSrc = src;
  ...
  return (
    <div ref={domRef} className="lazyimg" style={{ height: wrapperdivheight100 ? '100%' : 'unset', ...wrapperdivstyle }}>
      <LazyLoadImage
        {...newProps}
      />
    </div>
